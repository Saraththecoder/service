...
const ContactPage = () => {
  ...
  const schemaData = {
    ...
    "image": "https://nelloredoorstepservice.com/logo.png",
    "telephone": "+91-9701308392",
    "email": "support@nelloredoorstepservice.com",
    "priceRange": "$$",
    "address": {
      "@type": "PostalAddress",
    ...
    "url": "https://nelloredoorstepservice.com/contact",
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://nelloredoorstepservice.com/contact" />
        ...
        <meta property="og:url" content="https://nelloredoorstepservice.com/contact" />
